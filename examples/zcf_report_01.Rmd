...
```{r code, fig.cap='In regions where domestic solar output now regularly exceeds local demand, such as Morphet Vale  in South Australia,  flow reversals on DNSP zone substations is adding costs to grid operation', echo=FALSE}
library(ggplot2)
library(nord)
