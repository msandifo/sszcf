...
![Figure 2. In regions where domestic solar output now regularly exceeds local demand, such as Morphet Vale east in South Australia,  flow reversals on DNSP zone substations is adding costs to grid operation.](figs/mv_byhourofday_nov.png)
