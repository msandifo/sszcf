...
Sunshot Industries invests transformational capital and know-how in energy intensive businesses, seeking to exit once the business is on a cost-advantaged, low carbon footing.

Sunshot Industries specifically  seeks to help  sectors with clear prospects to establish a competitive position in the top quartile of global energy/emission intensive industry with  the prospect for delivering substantial CO2e abatement.

Sunshot Industries is built on the vision espoused by Prof Ross Garnaut, in his books Superpower and Reset, that Australia is well placed to take  a leading role in the new low carbon economy.


> "We have unparalleled renewable energy resources.  We also have the necessary scientific skills. 
> Australia could be the natural home for an increasing proportion of global industry. 
> But how do we make this happen?"

> `r tufte::quote_footer('--- Ross Garnaut, Superpower 2019')`


Sunshot ZCF provides advisory to Sunshot Industries and partners pertinent to  the question "How do we make this happen?"
...
![Figure 1. Proportion of households with solar installations by wealth decile. 1 is the lowest wealth-decile,   10 is the highest (source Rohan Best).](figs/wealth-decile.png)
...
<<<<<<< HEAD
=======
![Figure 2. In locations where domestic solar output can exceed,  local demand the reversal of flows  on DNSP zone substations such as Morphet Vale east in South Australia, adds to costs to grid operators.](figs/min-system-load.png)
>>>>>>> 1e016d0c1501eda0cd4aeb3ecf5dd248d6b4dddb
